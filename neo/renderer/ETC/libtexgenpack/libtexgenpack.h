...
#define FILE_TYPE_ASTC		0x203	// Requires ASTC Evaluation Codec to be path accessible in order to work
...
#define TEXTURE_TYPE_ASTC_BIT				0x8000
	...
	typedef double(*TextureComparisonFunction)(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
...
#define SPEED_SLOW	3
	...
	bool convert_image_from_half_float(Image *image, float range_min, float range_max, float gamma);
	...
	// Defined in compress.cpp

	bool compress_image(const Options *opt, Image *image, int texture_type, CompressCallbackFunction func, Texture *texture,
		int genetic_parameters, float mutation_prob, float crossover_prob);

	// Defined in mipmap.cpp

	bool generate_mipmap_level_from_original(Image *source_image, int level, Image *dest_image);
	bool generate_mipmap_level_from_previous_level(Image *source_image, Image *dest_image);
	int count_mipmap_levels(Image *image);

	// Defined in file.cpp

	bool load_pkm_file(const char *filename, Texture *texture);
	bool save_pkm_file(Texture *texture, const char *fikename);
	...
	bool set_texture_decoding_function(const Options *opt, Texture *texture, Image *image);

	// Defined in compare.cpp

	double compare_block_any_size_rgba(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgb(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgba(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgb8_with_half_float(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgba8_with_half_float(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_8_bit_components(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_signed_8_bit_components(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_8_bit_components_with_16_bit(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_signed_8_bit_components_with_16_bit(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_r16(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rg16(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_r16_signed(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rg16_signed(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgb_half_float(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgba_half_float(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_r_half_float(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rg_half_float(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgb_half_float_hdr(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);
	double compare_block_4x4_rgba_half_float_hdr(unsigned int *image_buffer, BlockUserData *user_data, FILE* error_print);

	// Defined in half_float.cpp
