...
#define ENCODE_BIT			0x10000
	...
	bool compress_image_to_astc_texture(const Options *opt, Image *image, int texture_type, Texture *exture);
	...
	// Function defined in texture.cpp.
