...
/*
========================
idSignInManagerQnx::Shutdown
========================
*/
void idSignInManagerQnx::Shutdown() {
}

/*
========================
idSignInManagerQnx::Pump
========================
*/
void idSignInManagerQnx::Pump() {
...
/*
========================
idSignInManagerQnx::RemoveLocalUserByIndex
========================
*/
void idSignInManagerQnx::RemoveLocalUserByIndex( int index ) {
...
/*
========================
idSignInManagerQnx::RegisterLocalUser
========================
*/
void idSignInManagerQnx::RegisterLocalUser( int inputDevice ) {
	...
	strcpy(machineName, "qnx_bb10");
	//XXX ::GetComputerName( machineName, &len );
...
/*
========================
idSignInManagerQnx::CreateNewUser
========================
*/
bool idSignInManagerQnx::CreateNewUser( qnxUserState_t & state ) {
